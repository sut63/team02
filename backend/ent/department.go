...
func (e DepartmentEdges) PersonnelOrErr() ([]*Personnel, error) {
	if e.loadedTypes[0] {
...
// QueryPersonnel queries the "Personnel" edge of the Department entity.
func (d *Department) QueryPersonnel() *PersonnelQuery {
	return (&DepartmentClient{config: d.config}).QueryPersonnel(d)
}
