...
func ID(id int) predicate.Surgerytype {
...
func IDEQ(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func Typename(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameEQ(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTypename), v))
	})
}
...
func TypenameNEQ(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameIn(vs ...string) predicate.Surgerytype {
...
func TypenameNotIn(vs ...string) predicate.Surgerytype {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypenameGT(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameGTE(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameLT(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameLTE(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameContains(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameHasPrefix(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameHasSuffix(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func TypenameEqualFold(v string) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
...
func And(predicates ...predicate.Surgerytype) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.Surgerytype) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.Surgerytype) predicate.Surgerytype {
	return predicate.Surgerytype(func(s *sql.Selector) {
		p(s.Not())
	})
}
