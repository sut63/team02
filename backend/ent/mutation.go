...
type DepartmentMutation struct {
	...
	department        *string
	clearedFields     map[string]struct{}
	_Personnel        map[int]struct{}
	removed_Personnel map[int]struct{}
	cleared_Personnel bool
	done              bool
...
// OldDepartment returns the old "department" field's value of the Department entity.
...
func (m *DepartmentMutation) AddPersonnelIDs(ids ...int) {
	if m._Personnel == nil {
		m._Personnel = make(map[int]struct{})
	}
	for i := range ids {
		m._Personnel[ids[i]] = struct{}{}
	}
}

// ClearPersonnel clears the "Personnel" edge to the Personnel entity.
func (m *DepartmentMutation) ClearPersonnel() {
	m.cleared_Personnel = true
}

// PersonnelCleared returns if the "Personnel" edge to the Personnel entity was cleared.
func (m *DepartmentMutation) PersonnelCleared() bool {
	return m.cleared_Personnel
}

// RemovePersonnelIDs removes the "Personnel" edge to the Personnel entity by IDs.
func (m *DepartmentMutation) RemovePersonnelIDs(ids ...int) {
	if m.removed_Personnel == nil {
		m.removed_Personnel = make(map[int]struct{})
	}
	for i := range ids {
		m.removed_Personnel[ids[i]] = struct{}{}
	}
}

// RemovedPersonnel returns the removed IDs of the "Personnel" edge to the Personnel entity.
func (m *DepartmentMutation) RemovedPersonnelIDs() (ids []int) {
	for id := range m.removed_Personnel {
		ids = append(ids, id)
	}
	return
}
...
// PersonnelIDs returns the "Personnel" edge IDs in the mutation.
func (m *DepartmentMutation) PersonnelIDs() (ids []int) {
	for id := range m._Personnel {
		ids = append(ids, id)
	}
	return
}
...
// ResetPersonnel resets all changes to the "Personnel" edge.
func (m *DepartmentMutation) ResetPersonnel() {
	m._Personnel = nil
	m.cleared_Personnel = false
	m.removed_Personnel = nil
}
...
func (m *DepartmentMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m._Personnel != nil {
		edges = append(edges, department.EdgePersonnel)
	}
	return edges
}
...
func (m *DepartmentMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case department.EdgePersonnel:
		ids := make([]ent.Value, 0, len(m._Personnel))
		for id := range m._Personnel {
			ids = append(ids, id)
		}
		return ids
...
func (m *DepartmentMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case department.EdgePersonnel:
		ids := make([]ent.Value, 0, len(m.removed_Personnel))
		for id := range m.removed_Personnel {
			ids = append(ids, id)
		}
		return ids
...
func (m *PersonnelMutation) DepartmentIDs() (ids []int) {
...
func (m *PersonnelMutation) AddedEdges() []string {
	...
	if m._Department != nil {
		edges = append(edges, personnel.EdgeDepartment)
	}
	return edges
}
...
// SetPrice sets the "price" field.
func (m *PhysicaltherapyrecordMutation) SetPrice(i int) {
	m.price = &i
	m.addprice = nil
}

// Price returns the value of the "price" field in the mutation.
func (m *PhysicaltherapyrecordMutation) Price() (r int, exists bool) {
	v := m.price
	if v == nil {
		return
	}
...
// OldPrice returns the old "price" field's value of the Physicaltherapyrecord entity.
// If the Physicaltherapyrecord object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PhysicaltherapyrecordMutation) OldPrice(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldPrice is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddPrice adds i to the "price" field.
func (m *PhysicaltherapyrecordMutation) AddPrice(i int) {
	if m.addprice != nil {
		*m.addprice += i
	} else {
		m.addprice = &i
...
// AddedPrice returns the value that was added to the "price" field in this mutation.
func (m *PhysicaltherapyrecordMutation) AddedPrice() (r int, exists bool) {
	v := m.addprice
	if v == nil {
		return
	}
...
// ResetPrice resets all changes to the "price" field.
func (m *PhysicaltherapyrecordMutation) ResetPrice() {
	m.price = nil
	m.addprice = nil
}

// SetPhone sets the "phone" field.
func (m *PhysicaltherapyrecordMutation) SetPhone(s string) {
	m.phone = &s
}

// Phone returns the value of the "phone" field in the mutation.
func (m *PhysicaltherapyrecordMutation) Phone() (r string, exists bool) {
	v := m.phone
	if v == nil {
		return
	}
...
// OldPhone returns the old "phone" field's value of the Physicaltherapyrecord entity.
// If the Physicaltherapyrecord object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PhysicaltherapyrecordMutation) OldPhone(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldPhone is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPhone resets all changes to the "phone" field.
func (m *PhysicaltherapyrecordMutation) ResetPhone() {
	m.phone = nil
}

// SetNote sets the "note" field.
func (m *PhysicaltherapyrecordMutation) SetNote(s string) {
	m.note = &s
}

// Note returns the value of the "note" field in the mutation.
func (m *PhysicaltherapyrecordMutation) Note() (r string, exists bool) {
	v := m.note
	if v == nil {
		return
	}
...
// OldNote returns the old "note" field's value of the Physicaltherapyrecord entity.
// If the Physicaltherapyrecord object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PhysicaltherapyrecordMutation) OldNote(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldNote is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetNote resets all changes to the "note" field.
func (m *PhysicaltherapyrecordMutation) ResetNote() {
	m.note = nil
}
...
func (m *PhysicaltherapyrecordMutation) Fields() []string {
	...
	if m.phone != nil {
		fields = append(fields, physicaltherapyrecord.FieldPhone)
	}
	if m.note != nil {
		fields = append(fields, physicaltherapyrecord.FieldNote)
	}
	if m.appointtime != nil {
...
func (m *SurgeryappointmentMutation) SetCost(i int) {
	m.cost = &i
	m.addcost = nil
}

// Cost returns the value of the "cost" field in the mutation.
func (m *SurgeryappointmentMutation) Cost() (r int, exists bool) {
	v := m.cost
	if v == nil {
		return
	}
...
// OldCost returns the old "cost" field's value of the Surgeryappointment entity.
// If the Surgeryappointment object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SurgeryappointmentMutation) OldCost(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldCost is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *SurgeryappointmentMutation) AddCost(i int) {
	if m.addcost != nil {
		*m.addcost += i
	} else {
		m.addcost = &i
...
func (m *SurgeryappointmentMutation) AddedCost() (r int, exists bool) {
	v := m.addcost
	if v == nil {
		return
	}
...
func (m *SurgeryappointmentMutation) ResetCost() {
	m.cost = nil
	m.addcost = nil
}
